...
class Fornecedor(models.Model):
    ...
    arquivo_medicamentos = models.FileField('Relação medicamentos', null=True, blank=True, upload_to='midias',
                                            help_text='Arquivos .csv')
    tipo_fornecedor = models.CharField('Tipo de fornecedor *', max_length=10, choices=FORNECEDOR_TIPO,
